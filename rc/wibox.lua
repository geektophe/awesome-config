...
for s = 1, screen.count() do
    ...
    mywibox[s].widgets = {
        ...
        widgets.net.widget(),
        utils.system.isdir('/sys/class/power_supply/BAT0') and widgets.spacer.widget() or nil,
        utils.system.isdir('/sys/class/power_supply/BAT0') and widgets.bat.widget() or nil,
        widgets.spacer.widget(),
        widgets.fs.widget(),
        widgets.spacer.widget(),
        widgets.mem.widget(),
